...
public class SelectSymbolValidator {
    ...
    private final static InnerVisitor VISITOR = new InnerVisitor();
    ...
    private static class InnerVisitor extends SymbolVisitor<SelectSymbolValidator.SelectContext, Void> {
