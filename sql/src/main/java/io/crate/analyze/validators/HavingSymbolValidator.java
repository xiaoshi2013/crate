...
public class HavingSymbolValidator extends SymbolVisitor<HavingSymbolValidator.HavingContext, Void> {
    ...
    public void validate(Symbol having, @Nullable List<Symbol> groupBySymbols) throws IllegalArgumentException {
