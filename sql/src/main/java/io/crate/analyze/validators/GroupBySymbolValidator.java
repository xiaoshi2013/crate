...
public class GroupBySymbolValidator {
    ...
    public GroupBySymbolValidator() {
        innerVisitor = new InnerVisitor();
    }

    public void validate(Symbol groupBySymbol) throws IllegalArgumentException, UnsupportedOperationException {
        innerVisitor.process(groupBySymbol, null);
    }

    static class InnerVisitor extends SymbolVisitor<Void, Void> {
